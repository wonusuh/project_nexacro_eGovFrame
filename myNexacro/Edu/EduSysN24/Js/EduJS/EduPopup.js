...
// 	    nTop  = curY + (objApp.mainframe.height / 2) - Math.round(nHeight / 2) ;				
    ...
    if(sPopupType == "modeless"){
        var sOpenStyle= "showtitlebar=true titlebarheight=33 border='1px solid #acacac' showstatusbar=false showontaskbar=true showcascadetitletext=false resizable=true autosize="+bAutoSize+" titletext="+sTitleText;
